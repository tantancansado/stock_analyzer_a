...
# /api/analyze-ai/<ticker> se retiró el 14-sep-2026 junto con la página de
# búsqueda: era su único consumidor. Llamaba a Claude en CADA petición sin pasar
# por el contador del presupuesto que sí se commitea, así que gastaba sin
# contarse ni limitarse. Esta app es una lista de ideas ya filtradas, no un
# buscador al que preguntarle por cualquier acción.
